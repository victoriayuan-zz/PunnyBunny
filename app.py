        ...
        for entry in data["entry"]:
            for messaging_event in entry["messaging"]:
                ...
                if messaging_event.get("message"):  # someone sent us a message
                    ...
                    puns = ['Every bunny was kungfu fighting~', 'I’d make a veggie pun but no one would carrot all', 'I whip my hare back and forth~', 'And now he’s just some bunny that I used to know~',
